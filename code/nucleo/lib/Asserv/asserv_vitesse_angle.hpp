...
#define KP_MG 14//18 //coefficient proportionnel Asserv Vitesse Moteur Gauche 
#define KI_MG 0.15//0.15  //coefficient intégral Asserv Vitesse Moteur Gauche
#define KP_MD 14//18 //coefficient proportionnel Asserv Vitesse Moteur Droit
...
#define KP_Angle 0.00175// 0.00082 coefficient proportionnel Asserv Position (Angle)
#define KI_Angle 0//0.000001//0.0000008//0.000008 coefficient intégral Asserv Position (Angle)
#define KD_Angle 1.2//coefficient dérivé Asserv Position (Angle)
