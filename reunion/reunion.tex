...
\end{itemize}
\begin{multicols}{2}
\subsection{Tâches à faire par le robot}
...
\subsection{Objectifs de la prochaine réunion}
\begin{itemize}
...
\subsection{Définition des méthodes}
\begin{center}
\begin{tikzpicture}
...
\subsection{Objectif de la prochaine réunion}
\begin{itemize}
...
\subsection{Point asservissement}
...
\subsection{Point Asservissement + Info}
...
\node[individu] (A4) at (3,-2) {\xout{Aurélian}};
